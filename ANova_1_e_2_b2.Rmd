...
## Teste Bolsonaro 1T (facada + Bolsonaro)

Testando a hipótese que Bolsonaro tem a diferença de Positivo + Neutro - Negativo maior que a média do universo.
...
```{r}
 ...
 m <- mean(Tidy_Calculado_2T$Diferenca)
...
wilcox.test(Haddad2$Diferenca, mu=m)
...
boxplot(Haddad2$Diferenca, Tidy_Calculado_2T$Diferenca, 
        ...
        names = c("Haddad", "Média do Grupo"),  
        col = c("blue", "yellow"), 
        main = "Diferença entre Marina e a média do universo - 2o Turno")
```
...
wilcox.test(Bolsonaro2$Diferenca, mu=m)
